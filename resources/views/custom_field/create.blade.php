        ...
        <div class="box-body">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <label><input type="radio" name="required" required value="1"> {{trans_choice('general.yes',1)}}
                    </label>
                </div>
                <div class="form-group">
