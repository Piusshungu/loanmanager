        ...
        <div class="box-body">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <label><input type="radio" name="required" required value="1" @if($custom_field->required==1) checked @endif> {{trans_choice('general.yes',1)}}</label>
                </div>
                <div class="form-group">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="field_type" id="inputType" value="date" required="" @if($custom_field->field_type=="date") checked @endif>
                        ...
                        <tr>
                            <td>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="field_type" id="inputType" value="number" required="" @if($custom_field->field_type=="number") checked @endif>
