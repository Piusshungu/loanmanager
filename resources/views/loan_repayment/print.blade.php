...
<div>
    ...
    <div style="width: 980px;height: 224px;margin-left: auto;margin-right: auto;border: solid thin rgba(204, 204, 204, 0.1);padding: 20px;text-transform: capitalize">
        ...
        <div style="width: 300px;margin-right: 40px;float: left">
            ...
            <b>{{trans_choice('general.maturity',1)}} {{trans_choice('general.date',1)}}</b><span class="pull-right">{{$loan->maturity_date}}</span><br><br>
    ...
    <div style="width: 980px;height: 180px;margin-top:30px;margin-left: auto;margin-right: auto;border: solid thin rgba(204, 204, 204, 0.1);padding: 20px;text-transform: capitalize">
        <h2><b>{{trans_choice('general.payment',1)}} Received:</b><span
                    class="pull-right">{{round($repayment->amount,2)}}</span></h2>
        <h2><b>{{trans_choice('general.collection',1)}} {{trans_choice('general.date',1)}}:</b><span
                    class="pull-right">{{$repayment->collection_date}}</span></h2>
        <h2><b>{{trans_choice('general.collected_by',1)}}:</b><span
                    class="pull-right">{{$repayment->user->first_name}} {{$repayment->user->last_name}}</span></h2>
        <hr>
    </div>
</div>
