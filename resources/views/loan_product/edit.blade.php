...
@section('title')
    {{trans_choice('general.edit',1)}} {{trans_choice('general.loan',1)}} {{trans_choice('general.product',1)}}
@endsection
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans_choice('general.edit',1)}} {{trans_choice('general.loan',1)}} {{trans_choice('general.product',1)}}</h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        {!! Form::open(array('url' => url('loan/loan_product/'.$loan_product->id.'/update'), 'method' => 'post', 'class' => 'form-horizontal')) !!}
        <div class="box-body">
            <div class="form-group">
                {!! Form::label('name',trans_choice('general.name',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                    {!! Form::text('name',$loan_product->name, array('class' => 'form-control', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
            </div>
            <div class="slidingDiv">
                    ...
                    <div class="col-sm-3">
                        @foreach($loan_disbursed_by as $key)
                            <label> <input class="inputDisbursedById" type="checkbox" name="loan_disbursed_by_id[]"
                                           value="{{$key->id}}"
                                           @if(in_array($key->id,unserialize($loan_product->loan_disbursed_by_id))) checked @endif>{{$key->name}}
                            </label>
                            <br>
                        @endforeach
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        {!! Form::text('minimum_principal',$loan_product->minimum_principal, array('class' => 'form-control touchspin', 'placeholder'=>"")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        {!! Form::text('default_principal',$loan_product->default_principal, array('class' => 'form-control touchspin', 'placeholder'=>"")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        {!! Form::text('maximum_principal',$loan_product->maximum_principal, array('class' => 'form-control touchspin', 'placeholder'=>"")) !!}
                    </div>
                </div>
                <hr>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        {!! Form::text('default_interest_rate',$loan_product->default_interest_rate, array('class' => 'form-control touchspin', 'placeholder'=>"")) !!}
                    </div>
                    <div class="col-sm-3">
                        {!! Form::select('interest_period',array('day'=>trans_choice('general.per_day',1),'week'=>trans_choice('general.per_week',1),'month'=>trans_choice('general.per_month',1),'year'=>trans_choice('general.per_year',1)),$loan_product->interest_period, array('class' => 'form-control', 'placeholder'=>"","id"=>"inputDefaultInterestPeriod")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        {!! Form::text('minimum_interest_rate',$loan_product->minimum_interest_rate, array('class' => 'form-control touchspin', 'placeholder'=>"")) !!}
                    </div>
                    <div class="col-sm-3">
                        {!! Form::select('',array('day'=>trans_choice('general.per_day',1),'week'=>trans_choice('general.per_week',1),'month'=>trans_choice('general.per_month',1),'year'=>trans_choice('general.per_year',1)),$loan_product->interest_period, array('class' => 'form-control', 'placeholder'=>"","id"=>"inputMinInterestPeriod")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        {!! Form::text('maximum_interest_rate',$loan_product->maximum_interest_rate, array('class' => 'form-control touchspin', 'placeholder'=>"")) !!}
                    </div>
                    <div class="col-sm-3">
                        {!! Form::select('',array('day'=>trans_choice('general.per_day',1),'week'=>trans_choice('general.per_week',1),'month'=>trans_choice('general.per_month',1),'year'=>trans_choice('general.per_year',1)),$loan_product->interest_period, array('class' => 'form-control', 'placeholder'=>"","id"=>"inputMaxInterestPeriod")) !!}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        {!! Form::select('override_interest',array('0'=>trans_choice('general.no',1),'1'=>trans_choice('general.yes',1)),$loan_product->override_interest, array('class' => 'form-control','id'=>'override_interest')) !!}
                    </div>
                </div>
                ...
                <div class="form-group" id="overrideDiv">
                    ...
                    <div class="col-sm-5">
                        {!! Form::text('override_interest_amount',$loan_product->override_interest_amount, array('class' => 'form-control touchspin','id'=>'override_interest_amount')) !!}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        {!! Form::number('default_loan_duration',$loan_product->default_loan_duration, array('class' => 'form-control', 'placeholder'=>"5")) !!}
                    </div>
                    <div class="col-sm-3">
                        {!! Form::select('default_loan_duration_type',array('day'=>trans_choice('general.day',1).'(s)','week'=>trans_choice('general.week',1).'(s)','month'=>trans_choice('general.month',1).'(s)','year'=>trans_choice('general.year',1).'(s)'),$loan_product->default_loan_duration_type, array('class' => 'form-control', 'placeholder'=>"","id"=>"inputMaxInterestPeriod")) !!}
                    </div>
                    <div class="col-sm-3">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        {!! Form::select('decimal_places',array('round_off_to_two_decimal'=>'round off to 2 decimal places','round_off_to_integer'=>'Round off to integer'),$loan_product->decimal_places, array('class' => 'form-control', 'placeholder'=>"","id"=>"")) !!}
                    </div>
                </div>
                <hr>
                <script>
                ...
                <p class="text-red"><b>{{trans_choice('general.repayment',1)}} {{trans_choice('general.order',1)}}:</b>
                </p>
                ...
                <div class="form-group">
                    <label for="inputLoanRepaymentOrder"
                           class="col-sm-3 control-label">{{trans_choice('general.repayment',1)}} {{trans_choice('general.order',1)}}</label>

                    <div class="col-xs-6">
                        {!! Form::select('repayment_order[]',array('penalty'=>trans_choice('general.penalty',1),'fees'=>trans_choice('general.fee',2),'interest'=>trans_choice('general.interest',1),'principal'=>trans_choice('general.principal',1)),unserialize($loan_product->repayment_order), array('class' => 'l', 'placeholder'=>"","multiple"=>"" ,"id"=>"to" ,"size"=>"7")) !!}
                    ...
                    <div class="checkbox col-sm-10">
                        <label>
                            <input type="checkbox" name="enable_late_repayment_penalty"
                                   ...
                                   value="0" @if($loan_product->enable_late_repayment_penalty==1) checked @endif>
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="late_repayment_penalty_type"
                                       id="late_repayment_penalty_type_percentage" value="percentage"
                                       @if($loan_product->late_repayment_penalty_type=="percentage") checked @endif> {{trans_choice('general.percentage_penalty',1)}}
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="late_repayment_penalty_type"
                                       id="late_repayment_penalty_type_fixed" value="fixed"
                                       @if($loan_product->late_repayment_penalty_type=="fixed") checked @endif> {{trans_choice('general.fixed_penalty',1)}}
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="late_repayment_penalty_calculate"
                           class="col-sm-4 control-label">{{trans_choice('general.calculate_penalty_on',1)}}</label>

                    <div class="col-sm-6">
                        {!! Form::select('late_repayment_penalty_calculate',array('overdue_principal'=>trans_choice('general.overdue_principal',1),'overdue_principal_interest'=>trans_choice('general.overdue_principal_interest',1),'overdue_principal_interest_fees'=>trans_choice('general.overdue_principal_interest_fees',1),'total_overdue'=>trans_choice('general.total_overdue',1)),$loan_product->late_repayment_penalty_calculate, array('class' => 'form-control', 'placeholder'=>"","id"=>"late_repayment_penalty_calculate")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('late_repayment_penalty_amount',$loan_product->late_repayment_penalty_amount, array('class' => 'form-control touchspin', 'id'=>"late_repayment_penalty_amount")) !!}
                    </div>
                </div>
                <div class="form-group">
                    <label for="late_repayment_penalty_grace_period"
                           class="col-sm-4 control-label">({{trans_choice('general.optional',1)}}
                        ) {{trans_choice('general.grace_period',1)}}</label>

                    <div class="col-sm-6">
                        {!! Form::number('late_repayment_penalty_grace_period',$loan_product->late_repayment_penalty_grace_period, array('class' => 'form-control', 'id'=>"late_repayment_penalty_grace_period","placeholder"=>"Enter number of days")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::number('late_repayment_penalty_recurring',$loan_product->late_repayment_penalty_recurring, array('class' => 'form-control', 'id'=>"late_repayment_penalty_recurring","placeholder"=>"Enter number of days")) !!}
                    </div>
                </div>
                <hr>
                    ...
                    <div class="checkbox col-sm-10">
                        <label>
                            <input type="checkbox" name="enable_after_maturity_date_penalty"
                                   ...
                                   value="0" @if($loan_product->enable_after_maturity_date_penalty==1) checked @endif>
                        ...
                        <div class="radio">
                            <label>
                                <input type="radio" name="after_maturity_date_penalty_type"
                                       id="after_maturity_date_penalty_type_percentage" value="percentage"
                                       @if($loan_product->after_maturity_date_penalty_type=="percentage") checked @endif>
                                {{trans_choice('general.percentage_penalty',1)}}
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                                <input type="radio" name="after_maturity_date_penalty_type"
                                       id="after_maturity_date_penalty_type_fixed" value="fixed"
                                       @if($loan_product->after_maturity_date_penalty_type=="fixed") checked @endif> {{trans_choice('general.fixed_penalty',1)}}
                            </label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::select('after_maturity_date_penalty_calculate',array('overdue_principal'=>trans_choice('general.overdue_principal',1),'overdue_principal_interest'=>trans_choice('general.overdue_principal_interest',1),'overdue_principal_interest_fees'=>trans_choice('general.overdue_principal_interest_fees',1),'total_overdue'=>trans_choice('general.total_overdue',1)),$loan_product->after_maturity_date_penalty_calculate, array('class' => 'form-control', 'placeholder'=>"","id"=>"after_maturity_date_penalty_calculate")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::text('after_maturity_date_penalty_amount',$loan_product->after_maturity_date_penalty_amount, array('class' => 'form-control touchspin', 'id'=>"after_maturity_date_penalty_amount")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::number('after_maturity_date_penalty_grace_period',$loan_product->after_maturity_date_penalty_grace_period, array('class' => 'form-control', 'id'=>"after_maturity_date_penalty_grace_period","placeholder"=>"Enter number of days")) !!}
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        {!! Form::number('after_maturity_date_penalty_recurring',$loan_product->after_maturity_date_penalty_recurring, array('class' => 'form-control', 'id'=>"after_maturity_date_penalty_recurring","placeholder"=>"Enter number of days")) !!}
                    </div>
                </div>
            </div>
