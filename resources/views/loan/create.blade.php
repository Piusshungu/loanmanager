...
@section('content')
    <div class="box box-primary">
        ...
        {!! Form::open(array('url' => url('loan/store'), 'method' => 'post', 'class' => 'form-horizontal',"enctype"=>"multipart/form-data")) !!}
        <div class="box-body">
            <div class="form-group">
                {!! Form::label('borrower_id',trans_choice('general.borrower',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                    {!! Form::select('borrower_id',$borrowers,$borrower_id, array('class' => ' select2 form-control', 'placeholder'=>"Select",'required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::text('principal',$loan_product->default_principal, array('class' => 'form-control touchspin', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
            </div>
            <hr>
            ...
            <p class="bg-navy disabled color-palette">{{trans_choice('general.other',2)}} ({{trans_choice('general.optional',2)}}):</p>
