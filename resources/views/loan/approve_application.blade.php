...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">{{trans_choice('general.approve',1)}} {{trans_choice('general.application',1)}}</h3>

            <div class="box-tools pull-right">

            </div>
        </div>
        {!! Form::open(array('url' => url('loan/loan_application/'.$application->id.'/store'), 'method' => 'post', 'class' => 'form-horizontal',"enctype"=>"multipart/form-data")) !!}
        <div class="box-body">
            <input type="hidden" name="borrower_id" value="{{$application->borrower_id}}"/>
            <input type="hidden" name="loan_product_id" value="{{$application->loan_product_id}}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::text('principal',$application->amount, array('class' => 'form-control touchspin', 'placeholder'=>"",'required'=>'required')) !!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('release_date',trans_choice('general.loan',1).' '.trans_choice('general.release',1).' '.trans_choice('general.date',1),array('class'=>'col-sm-3 control-label')) !!}
                <div class="col-sm-5">
                    {!! Form::text('release_date',null, array('class' => 'form-control date-picker', 'placeholder'=>"yyyy-mm-dd",'required'=>'required','id'=>'releaseDate')) !!}
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    {!! Form::text('first_payment_date',null, array('class' => 'form-control date-picker', 'placeholder'=>"yyyy-mm-dd",'required'=>'required','id'=>'firstPayment')) !!}
                </div>
            </div>
            <hr>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    {!! Form::number('loan_duration',$loan_product->default_loan_duration, array('class' => 'form-control', 'placeholder'=>"5",'required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                    {!! Form::select('loan_duration_type',array('day'=>trans_choice('general.day',1).'(s)','week'=>trans_choice('general.week',1).'(s)','month'=>trans_choice('general.month',1).'(s)','year'=>trans_choice('general.year',1).'(s)'),$loan_product->default_loan_duration_type, array('class' => 'form-control',"id"=>"inputMaxInterestPeriod",'required'=>'required')) !!}
                </div>
                <div class="col-sm-3">
                </div>
            </div>
