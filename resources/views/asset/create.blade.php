                ...
                <div class="col-sm-12">
                    <table width="100%" id="current_valuation" class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="bg-gray padding"><b>{{trans_choice('general.date',1)}} {{trans_choice('general.of',1)}} {{trans_choice('general.valuation',1)}}</b></td>
                            <td class="bg-gray padding"><b>{{trans_choice('general.value',1)}} {{trans_choice('general.amount',1)}}</b></td>
                        </tr>
                        <tr>
                            <td>
                                1
