            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="email_templates">
                        ...
                        <p>You can use any of the following tags: <span class="label label-info">{paymentAmount}</span> <span
                    ...
                    <div class="tab-pane active" id="system">
                        ...
                        <div class="form-group">
                            {!! Form::label('client_request_guarantor',trans('general.client_request_guarantor'),array('class'=>'col-sm-3 control-label')) !!}
                            <div class="col-sm-9">
                                {!! Form::select('client_request_guarantor',array('1'=>trans('general.yes'),'0'=>trans('general.no')),\App\Models\Setting::where('setting_key','client_request_guarantor')->first()->setting_value,array('class'=>'form-control')) !!}
                            </div>
                        </div>
                        <div class="form-group">
